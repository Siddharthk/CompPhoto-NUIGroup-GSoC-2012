...
IplImage* Normal_Blending::normal_blend(IplImage *I, IplImage *mask, int posx, int posy)
{
...
IplImage* Mixed_Blending::mixed_blend(IplImage *I, IplImage *mask, int posx, int posy)
{
...
IplImage* Local_color_change::color_change(IplImage *I, IplImage *mask, int posx, int posy, float red, float green, float blue)
{
...
IplImage* Local_illum_change::illum_change(IplImage *I, IplImage *mask, int posx, int posy, float alpha, float beta)
{
...
IplImage* Mono_trans::monochrome_transfer(IplImage *I, IplImage *mask, int posx, int posy)
{
